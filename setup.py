...
setup(
    ...
    author_email="",
    description="LiteLLM Configuration Management Tool - Automated Multi-Provider Setup",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/mmdsnb/freerouter",
    project_urls={
        "Bug Tracker": "https://github.com/mmdsnb/freerouter/issues",
        "Documentation": "https://github.com/mmdsnb/freerouter/blob/main/README.md",
        "Source Code": "https://github.com/mmdsnb/freerouter",
    },
    packages=find_packages(exclude=["tests", "tests.*", "scripts", "docs"]),
    include_package_data=True,
    keywords=["llm", "litellm", "openai", "ai", "router", "proxy", "configuration"],
    classifiers=[
